...
| **Cursor** | [`apps/cursor.json`](apps/cursor.json) | [`pkgforge-dev/Cursor-AppImage-enhanced`](https://github.com/pkgforge-dev/Cursor-AppImage-enhanced) |
| **cursor-cli** | [`apps/cursor-cli.json`](apps/cursor-cli.json) | [`pkgforge-dev/cursor-cli-AppImage`](https://github.com/pkgforge-dev/cursor-cli-AppImage) |
| **D1X-Rebirth** | [`apps/d1x-rebirth.json`](apps/d1x-rebirth.json) | [`pkgforge-dev/D1X-Rebirth-AppImage`](https://github.com/pkgforge-dev/D1X-Rebirth-AppImage) |
...
| **Dillo** | [`apps/dillo.json`](apps/dillo.json) | [`pkgforge-dev/Dillo-AppImage`](https://github.com/pkgforge-dev/Dillo-AppImage) |
| **DNZHRecomp** | [`apps/dnzhrecomp.json`](apps/dnzhrecomp.json) | [`pkgforge-dev/DNZHRecomp-AppImage`](https://github.com/pkgforge-dev/DNZHRecomp-AppImage) |
...
| **ECWolf** | [`apps/ecwolf.json`](apps/ecwolf.json) | [`pkgforge-dev/ECWolf-AppImage`](https://github.com/pkgforge-dev/ECWolf-AppImage) |
...
| **Gearcoleco** | [`apps/gearcoleco.json`](apps/gearcoleco.json) | [`pkgforge-dev/Gearcoleco-AppImage`](https://github.com/pkgforge-dev/Gearcoleco-AppImage) |
| **Geargrafx** | [`apps/geargrafx.json`](apps/geargrafx.json) | [`pkgforge-dev/Geargrafx-AppImage`](https://github.com/pkgforge-dev/Geargrafx-AppImage) |
| **Gearlynx** | [`apps/gearlynx.json`](apps/gearlynx.json) | [`pkgforge-dev/Gearlynx-AppImage`](https://github.com/pkgforge-dev/Gearlynx-AppImage) |
| **Gearsystem** | [`apps/gearsystem.json`](apps/gearsystem.json) | [`pkgforge-dev/Gearsystem-AppImage`](https://github.com/pkgforge-dev/Gearsystem-AppImage) |
...
| **Gnome Text Editor** | [`apps/gnome-text-editor.json`](apps/gnome-text-editor.json) | [`pkgforge-dev/Gnome-Text-Editor-AppImage`](https://github.com/pkgforge-dev/Gnome-Text-Editor-AppImage) |
| **gpu-screen-recorder** | [`apps/gpu-screen-recorder.json`](apps/gpu-screen-recorder.json) | [`pkgforge-dev/gpu-screen-recorder-AppImage`](https://github.com/pkgforge-dev/gpu-screen-recorder-AppImage) |
| **htop** | [`apps/htop.json`](apps/htop.json) | [`pkgforge-dev/htop-AppImage`](https://github.com/pkgforge-dev/htop-AppImage) |
| **iloader** | [`apps/iloader.json`](apps/iloader.json) | [`pkgforge-dev/iloader-AppImage-Enhanced`](https://github.com/pkgforge-dev/iloader-AppImage-Enhanced) |
| **innoextract** | [`apps/innoextract.json`](apps/innoextract.json) | [`pkgforge-dev/innoextract-AppImage`](https://github.com/pkgforge-dev/innoextract-AppImage) |
| **isle-portable** | [`apps/isle-portable.json`](apps/isle-portable.json) | [`pkgforge-dev/isle-portable-AppImage-Enhanced`](https://github.com/pkgforge-dev/isle-portable-AppImage-Enhanced) |
...
| **LocalSend** | [`apps/localsend.json`](apps/localsend.json) | [`pkgforge-dev/localsend-AppImage`](https://github.com/pkgforge-dev/localsend-AppImage) |
...
| **Mini-vMac** | [`apps/mini-vmac.json`](apps/mini-vmac.json) | [`pkgforge-dev/Mini-vMac-AppImage`](https://github.com/pkgforge-dev/Mini-vMac-AppImage) |
| **NBlood** | [`apps/nblood.json`](apps/nblood.json) | [`pkgforge-dev/NBlood-AppImage`](https://github.com/pkgforge-dev/NBlood-AppImage) |
| **NFSIISE** | [`apps/nfsiise.json`](apps/nfsiise.json) | [`pkgforge-dev/NFSIISE-AppImage`](https://github.com/pkgforge-dev/NFSIISE-AppImage) |
| **Nitrogen** | [`apps/nitrogen.json`](apps/nitrogen.json) | [`pkgforge-dev/Nitrogen-AppImage`](https://github.com/pkgforge-dev/Nitrogen-AppImage) |
| **NSZ** | [`apps/nsz.json`](apps/nsz.json) | [`pkgforge-dev/NSZ-AppImage`](https://github.com/pkgforge-dev/NSZ-AppImage) |
...
| **OpenLara** | [`apps/openlara.json`](apps/openlara.json) | [`pkgforge-dev/OpenLara-AppImage`](https://github.com/pkgforge-dev/OpenLara-AppImage) |
| **OpenLoco** | [`apps/openloco.json`](apps/openloco.json) | [`pkgforge-dev/OpenLoco-AppImage`](https://github.com/pkgforge-dev/OpenLoco-AppImage) |
...
| **Perfect Dark** | [`apps/perfect-dark.json`](apps/perfect-dark.json) | [`pkgforge-dev/Perfect-Dark-AppImage`](https://github.com/pkgforge-dev/Perfect-Dark-AppImage) |
| **Phantom-Satellite** | [`apps/phantom-satellite.json`](apps/phantom-satellite.json) | [`pkgforge-dev/Phantom-Satellite-AppImage`](https://github.com/pkgforge-dev/Phantom-Satellite-AppImage) |
| **phoenix-x-server** | [`apps/phoenix-x-server.json`](apps/phoenix-x-server.json) | [`pkgforge-dev/phoenix-x-server-AppImage`](https://github.com/pkgforge-dev/phoenix-x-server-AppImage) |
| **Piglit** | [`apps/piglit.json`](apps/piglit.json) | [`pkgforge-dev/Piglit-AppImage`](https://github.com/pkgforge-dev/Piglit-AppImage) |
| **Pixelpulse2** | [`apps/pixelpulse2.json`](apps/pixelpulse2.json) | [`pkgforge-dev/Pixelpulse2-AppImage`](https://github.com/pkgforge-dev/Pixelpulse2-AppImage) |
| **playerctl** | [`apps/playerctl.json`](apps/playerctl.json) | [`pkgforge-dev/playerctl-AppImage`](https://github.com/pkgforge-dev/playerctl-AppImage) |
| **Plus42** | [`apps/plus42.json`](apps/plus42.json) | [`pkgforge-dev/Plus42-AppImage`](https://github.com/pkgforge-dev/Plus42-AppImage) |
| **polybar** | [`apps/polybar.json`](apps/polybar.json) | [`pkgforge-dev/polybar-AppImage`](https://github.com/pkgforge-dev/polybar-AppImage) |
| **POSTAL** | [`apps/postal.json`](apps/postal.json) | [`pkgforge-dev/POSTAL-AppImage`](https://github.com/pkgforge-dev/POSTAL-AppImage) |
| **Prey2006** | [`apps/prey2006.json`](apps/prey2006.json) | [`pkgforge-dev/Prey2006-AppImage`](https://github.com/pkgforge-dev/Prey2006-AppImage) |
...
| **Rednukem** | [`apps/rednukem.json`](apps/rednukem.json) | [`pkgforge-dev/Rednukem-AppImage`](https://github.com/pkgforge-dev/Rednukem-AppImage) |
| **REDRIVER2** | [`apps/redriver2.json`](apps/redriver2.json) | [`pkgforge-dev/REDRIVER2-AppImage`](https://github.com/pkgforge-dev/REDRIVER2-AppImage) |
...
| **system-monitoring-center** | [`apps/system-monitoring-center.json`](apps/system-monitoring-center.json) | [`pkgforge-dev/system-monitoring-center-AppImage`](https://github.com/pkgforge-dev/system-monitoring-center-AppImage) |
...
| **Torzu** | [`apps/torzu.json`](apps/torzu.json) | [`pkgforge-dev/Torzu-AppImage`](https://github.com/pkgforge-dev/Torzu-AppImage) |
| **TouchHLE** | [`apps/touchhle.json`](apps/touchhle.json) | [`pkgforge-dev/TouchHLE-AppImage`](https://github.com/pkgforge-dev/TouchHLE-AppImage) |
| **uad-ng** | [`apps/uad-ng.json`](apps/uad-ng.json) | [`pkgforge-dev/uad-ng-AppImage`](https://github.com/pkgforge-dev/uad-ng-AppImage) |
| **Ungoogled-chromium** | [`apps/ungoogled-chromium.json`](apps/ungoogled-chromium.json) | [`pkgforge-dev/Ungoogled-Chromium-AppImage`](https://github.com/pkgforge-dev/Ungoogled-Chromium-AppImage) |
| **UnleashedRecomp** | [`apps/unleashedrecomp.json`](apps/unleashedrecomp.json) | [`pkgforge-dev/UnleashedRecomp-AppImage`](https://github.com/pkgforge-dev/UnleashedRecomp-AppImage) |
| **VeraCrypt** | [`apps/veracrypt.json`](apps/veracrypt.json) | [`pkgforge-dev/VeraCrypt-AppImage`](https://github.com/pkgforge-dev/VeraCrypt-AppImage) |
| **Vibeprint Studio** | [`apps/vibeprint-studio.json`](apps/vibeprint-studio.json) | [`pkgforge-dev/Vibeprint-Studio-AppImage`](https://github.com/pkgforge-dev/Vibeprint-Studio-AppImage) |
...
| :--- | :--- | :--- |
| **2ship2harkinian** | `2ship2harkinian` | [`pkgforge-dev/2ship2harkinian-AppImage-Enhanced`](https://github.com/pkgforge-dev/2ship2harkinian-AppImage-Enhanced) |
| **BM64Recomp** | `bm64recomp` | [`pkgforge-dev/BM64Recomp-AppImage-Enhanced`](https://github.com/pkgforge-dev/BM64Recomp-AppImage-Enhanced) |
| **BMHeroRecomp** | `bmherorecomp` | [`pkgforge-dev/BMHeroRecomp-AppImage-Enhanced`](https://github.com/pkgforge-dev/BMHeroRecomp-AppImage-Enhanced) |
| **ChiPass** | `chipass` | [`pkgforge-dev/ChiPass-AppImage`](https://github.com/pkgforge-dev/ChiPass-AppImage) |
| **Clock Signal** | `clock-signal` | [`pkgforge-dev/CLK-AppImage`](https://github.com/pkgforge-dev/CLK-AppImage) |
| **DingusPPC** | `dingusppc` | [`pkgforge-dev/DingusPPC-AppImage`](https://github.com/pkgforge-dev/DingusPPC-AppImage) |
| **DonkeyKong64Recomp** | `donkeykong64recomp` | [`pkgforge-dev/DonkeyKong64Recomp-AppImage`](https://github.com/pkgforge-dev/DonkeyKong64Recomp-AppImage) |
| **ExtremeGRecomp** | `extremegrecomp` | [`pkgforge-dev/ExtremeGRecomp-AppImage`](https://github.com/pkgforge-dev/ExtremeGRecomp-AppImage) |
| **Foobillard++** | `foobillard` | [`pkgforge-dev/Foobillardpp-AppImage`](https://github.com/pkgforge-dev/Foobillardpp-AppImage) |
| **Ghostscript** | `ghostscript` | [`pkgforge-dev/Ghostscript-AppImage`](https://github.com/pkgforge-dev/Ghostscript-AppImage) |
| **GIMP-and-PhotoGIMP** | `gimp-and-photogimp` | [`pkgforge-dev/GIMP-and-PhotoGIMP-AppImage`](https://github.com/pkgforge-dev/GIMP-and-PhotoGIMP-AppImage) |
| **Helium Browser** | `helium-browser` | [`pkgforge-dev/Helium-Browser-AppImage-Enhanced`](https://github.com/pkgforge-dev/Helium-Browser-AppImage-Enhanced) |
| **HP-15C** | `hp-15c` | [`pkgforge-dev/HP-15C-Simulator-AppImage`](https://github.com/pkgforge-dev/HP-15C-Simulator-AppImage) |
| **ImageMagick** | `imagemagick` | [`pkgforge-dev/ImageMagick-AppImage`](https://github.com/pkgforge-dev/ImageMagick-AppImage) |
| **img2pdf** | `img2pdf` | [`pkgforge-dev/img2pdf-AppImage`](https://github.com/pkgforge-dev/img2pdf-AppImage) |
| **ITR2026** | `itr2026` | [`pkgforge-dev/ITR2026-AppImage`](https://github.com/pkgforge-dev/ITR2026-AppImage) |
| **Lighthouse** | `lighthouse` | [`pkgforge-dev/Lighthouse-AppImage-Enhanced`](https://github.com/pkgforge-dev/Lighthouse-AppImage-Enhanced) |
| **Myth II** | `myth-ii` | [`pkgforge-dev/Myth-II-AppImage`](https://github.com/pkgforge-dev/Myth-II-AppImage) |
| **NP2kai** | `np2kai` | [`pkgforge-dev/Neko-Project-II-Kai-AppImage`](https://github.com/pkgforge-dev/Neko-Project-II-Kai-AppImage) |
| **OpenMoHAA** | `openmohaa` | [`pkgforge-dev/OpenMoHAA-AppImage`](https://github.com/pkgforge-dev/OpenMoHAA-AppImage) |
| **OpenSnitch** | `opensnitch` | [`pkgforge-dev/OpenSnitch-AppImage`](https://github.com/pkgforge-dev/OpenSnitch-AppImage) |
| **OpenTESArena** | `opentesarena` | [`pkgforge-dev/OpenTESArena-AppImage`](https://github.com/pkgforge-dev/OpenTESArena-AppImage) |
| **Oxicord** | `oxicord` | [`pkgforge-dev/Oxicord-AppImage`](https://github.com/pkgforge-dev/Oxicord-AppImage) |
| **PCSX-Redux** | `pcsx-redux` | [`pkgforge-dev/PCSX-Redux-AppImage-Enhanced`](https://github.com/pkgforge-dev/PCSX-Redux-AppImage-Enhanced) |
| **Powermanga** | `powermanga` | [`pkgforge-dev/Powermanga-AppImage`](https://github.com/pkgforge-dev/Powermanga-AppImage) |
| **QuantumLauncher** | `quantumlauncher` | [`pkgforge-dev/QuantumLauncher-AppImage-Enhanced`](https://github.com/pkgforge-dev/QuantumLauncher-AppImage-Enhanced) |
| **Shiru** | `shiru` | [`pkgforge-dev/Shiru-AppImage`](https://github.com/pkgforge-dev/Shiru-AppImage) |
| **SnowboardKids2Recomp** | `snowboardkids2recomp` | [`pkgforge-dev/SnowboardKids2Recomp-AppImage`](https://github.com/pkgforge-dev/SnowboardKids2Recomp-AppImage) |
| **soh** | `soh` | [`pkgforge-dev/soh-AppImage-Enhanced`](https://github.com/pkgforge-dev/soh-AppImage-Enhanced) |
| **SpaghettiKart** | `spaghettikart` | [`pkgforge-dev/SpaghettiKart-AppImage-Enhanced`](https://github.com/pkgforge-dev/SpaghettiKart-AppImage-Enhanced) |
| **Themix** | `themix` | [`pkgforge-dev/Themix-GUI-AppImage`](https://github.com/pkgforge-dev/Themix-GUI-AppImage) |
